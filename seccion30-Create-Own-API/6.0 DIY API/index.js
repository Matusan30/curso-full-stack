...
app.put("/jokes/:id", (req, res) => {
  ...
  jokes[jokeIndex].jokeText = req.query.text;
  jokes[jokeIndex].jokeType = req.query.type;
...
app.delete("/all", (req, res) => {
  ...
  if (userKey === masterKey) {
    ...
    res
    .status(404)
    .json({error: `You're not authorised to perform this action.`})
  }
});
